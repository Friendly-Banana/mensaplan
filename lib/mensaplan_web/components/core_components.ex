defmodule MensaplanWeb.CoreComponents do
  @moduledoc """
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 text-blue-500 focus:ring-0"
          {@rest}
        />
        <%= @label %>
      </label>
      ...
      <table class="my-5 w-full">
        ...
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="hover:bg-zinc-50">
            ...
            >
              <div class="block py-2 md:py-4 pr-1 md:pr-3">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MensaplanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MensaplanWeb.Gettext, "errors", msg, opts)
    end
  end
